                        ...
                        <table class="table table-borderless mt-3">
                            <tbody>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <button class="btn btn-sm font-weight-bold" style="color: green; border-color: green;">
                                            {{ product.discount }} %
                                        </button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-pill badge-success"
                                            style="background-color: darkorange; font-size: 14px; border-radius: .3rem; padding: .25em .5em .2em;"> {{ product.weight }}
                                            gram</span>
                                    </td>
                                </tr>
                            </tbody>
